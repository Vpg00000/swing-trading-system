...
<td class="font-bold symbol-cell" data-symbol="${item.symbol}" data-pe="${item.pe||'24.5'}" data-high="${item.high||'₹3,120.00'}" data-low="${item.low||'₹2,210.00'}">
...
<td class="font-mono">₹${item.close || item.ltp || '--'}</td>
<td class="font-mono">${item.rsi || '--'}</td>
<td class="font-mono">${item.pe || '--'}</td>
<td class="font-mono">${item.roe ? item.roe + '%' : '--'}</td>
<td class="font-mono">${item.delivery_pct ? item.delivery_pct + '%' : '--'}</td>
<td><span class="badge badge-score">${item.composite_score || item.score || 0}</span></td>
<td>
...
<td class="font-mono text-mint">₹${item.target_price || '--'}</td>
<td class="font-mono text-red">₹${item.stop_loss || '--'}</td>
...
<span id="consensusScoreCounter" style="font-size: 2.2rem; font-weight: 800; font-family: var(--font-mono); color: #10b981;">0</span>
